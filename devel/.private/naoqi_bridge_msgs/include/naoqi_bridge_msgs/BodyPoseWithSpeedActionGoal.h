...
bool operator==(const ::naoqi_bridge_msgs::BodyPoseWithSpeedActionGoal_<ContainerAllocator1> & lhs, const ::naoqi_bridge_msgs::BodyPoseWithSpeedActionGoal_<ContainerAllocator2> & rhs)
{
