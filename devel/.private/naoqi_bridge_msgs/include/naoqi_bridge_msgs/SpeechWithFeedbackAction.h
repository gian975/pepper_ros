...
bool operator==(const ::naoqi_bridge_msgs::SpeechWithFeedbackAction_<ContainerAllocator1> & lhs, const ::naoqi_bridge_msgs::SpeechWithFeedbackAction_<ContainerAllocator2> & rhs)
{
