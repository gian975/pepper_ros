...
"""autogenerated by genpy from detect_srv/DetectRequest.msg. Do not edit."""
import codecs
import sys
...
class DetectRequest(genpy.Message):
  ...
  _type = "detect_srv/DetectRequest"
...
def _get_struct_BI():
    ...
    return _struct_BI
# This Python file uses the following encoding: utf-8
"""autogenerated by genpy from detect_srv/DetectResponse.msg. Do not edit."""
import codecs
import sys
python3 = True if sys.hexversion > 0x03000000 else False
import genpy
...
class DetectResponse(genpy.Message):
  _md5sum = "fae1e7f2d6efaedac191c053659f1c34"
  _type = "detect_srv/DetectResponse"
  _has_header = False  # flag to mark the presence of a Header object
  _full_text = """std_msgs/String[] objects
...
def _get_struct_I():
    ...
    return _struct_I
class Detect(object):
  _type          = 'detect_srv/Detect'
  _md5sum = 'cbdd439cb37e9b917711bccd925048b5'
