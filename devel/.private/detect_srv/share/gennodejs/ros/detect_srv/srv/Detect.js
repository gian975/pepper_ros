...
class DetectRequest {
  ...
  static datatype() {
    ...
    return 'detect_srv/DetectRequest';
  }
...
class DetectResponse {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    for (let i = 0; i < len; ++i) {
      data.objects[i] = std_msgs.msg.String.deserialize(buffer, bufferOffset)
    }
    return data;
  }
  ...
  static Resolve(msg) {
    ...
    if (msg.objects !== undefined) {
      ...
      for (let i = 0; i < resolved.objects.length; ++i) {
        resolved.objects[i] = std_msgs.msg.String.Resolve(msg.objects[i]);
      }
    }
    else {
      resolved.objects = []
...
module.exports = {
  ...
  md5sum() { return 'cbdd439cb37e9b917711bccd925048b5'; },
  datatype() { return 'detect_srv/Detect'; }
};
